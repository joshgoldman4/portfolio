...
public class MapServer {
    ...
    String[] REQUIRED_RASTER_REQUEST_PARAMS = {"ullat", "ullon", "lrlat", "lrlon", "w", "h"};
    /**
     ...
     **/
    private static final
    String[] REQUIRED_ROUTE_REQUEST_PARAMS = {"start_lat", "start_lon", "end_lat", "end_lon"};
    ...
    private static final String[] REQUIRED_RASTER_RESULT_PARAMS = {"render_grid",
        "raster_ul_lon", "raster_ul_lat", "raster_lr_lon", "raster_lr_lat", "depth",
        "query_success"};
    ...
    public static List<String> getLocationsByPrefix(String prefix) {
        ...
        List<String> sorted = graph.trie.getPrefix(prefix);
        return sorted;
    }
    ...
    public static List<Map<String, Object>> getLocations(String locationName) {
        ArrayList<Map<String, Object>> holder = new ArrayList<>();
        holder.addAll(graph.searches.get(graph.cleanString(locationName)));
        return holder;
    }
